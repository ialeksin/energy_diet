<?php 
	...
	{
		$a=file_get_contents('files/counter.txt');
		$a++;
		file_put_contents('files/counter.txt', $a);
		setcookie('visit');
	}
?>
<html>
...
<?php 
	...
	echo '
			<tr>
				<td colspan="4">
					<img  width="310"  height="370" src="images/', $productimgs[$i], '" align="left">
					<b>', $productnames[$i], '</b>
					<br>
					<br>
					', $productdescs[$i], '
...
<?php 
	...
	echo 'Число посещений сайта: ', file_get_contents('files/counter.txt');
?>
					</font>
				</td>
			</tr>
